...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d0d0d', color: '#ccc', fontFamily: 'sans-serif' }}>
      <nav style={{ background: '#161616', borderBottom: '1px solid #252525', padding: '12px 24px' }}>
        ...
        {/* Linha 2: botões de navegação + sair */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, flexWrap: 'wrap' }}>
          ...
          <div style={{ position: 'absolute', right: 24, display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ color: '#555', fontSize: 11 }}>{usuario.email}</span>
      ...
      {/* padding menor no mobile para aproveitar mais espaço */}
